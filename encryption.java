			...
			System.out.println("請輸入金鑰A");
			 ...
			 java.util.Scanner inputkeyB=new java.util.Scanner(System.in);
				System.out.println("請輸入金鑰B");
				 ...
				 for (int znumber=0; znumber<1;znumber++){			
			img = ImageIO.read(new File("C:\\ckey\\原圖.png"));
			img2 = ImageIO.read(new File("C:\\ckey\\原圖.png"));
			img3 = ImageIO.read(new File("C:\\ckey\\原圖.png"));
			img4 = ImageIO.read(new File("C:\\ckey\\原圖.png"));					
			f = new JFrame("");
			 f.setVisible(true);
			...
			data4=img4.getRGB(0,0,Width,Height,null,0,Width);
					...
					for(int xy=0;xy<data.length;xy++){													
						int offset=xy;
						 ...
						 int r2=(int)(Math.random()*(r+1)+0);
						 int g2=(int)(Math.random()*(g+1)+0);
						 int b2=(int)(Math.random()*(b+1)+0);
						  r=((rgb&0x00ff0000)>> 16)-r2;
						  g=((rgb&0x0000ff00)>> 8)-g2;
						  b=((rgb&0x000000ff))-b2;
						 rgb=(0xff000000|r<<16|g<<8|b);
						 data[offset]=rgb;	
						 rgb2=(0xff000000|r2<<16|g2<<8|b2);
						 data2[offset]=rgb2;
						}					
						...
						data2=img2.getRGB(0,0,Width,Height,null,0,Width);						
								...
								for(int xy=0;xy<data.length;xy++){													
									int offset=xy;
									 ...
									 g2=g-g2;
									 b2=b-b2;
									 rgb=(0xff000000|r2<<16|g2<<8|b2);
									 data[offset]=rgb;										
									}							
								ImageIO.write(img, "png", new File("C:\\ckey\\B.png"));								
						 }			
			 for (int znumber1=0; znumber1<1;znumber1++){
					try{
					...
					img4=CreateBufferedImage_Direct(data,Height,Width);	
						...
						int he =Height-rr2[1]-1;
						 for(int i= 0 ;i<Width; i++){
							 for(int k= 0 ;k<he; k++){
								int rgb=data2[k + i * he];
								 int rgb1=data[k + i * he];
